...
const Contact = (props) => {
    ...
    const handleSubmit = (e) => {
        ...
        emailjs.sendForm(
            'service_pyin8zo', 'template_3xema5l', e.target, 'user_PDVUm0P2xtCSGvc6gTsKc'
        )
        .then(
            (result) => {
        ...
        <Helmet title="Liên hệ">
            <div className="contact">
                <div className="contact__section-title">
                    ...
                    <p>Vui lòng điền vào biểu mẫu bên dưới để gửi email cho chúng tôi và chúng tôi sẽ liên hệ lại với bạn trong thời gian sớm nhất.</p>
                    {status && renderAlert()}
                </div>
                {/* FORM CONTACT */}
                <form name='sentMessage' onSubmit={handleSubmit}>
                    <Grid col={2} mdCol={2} smCol={1} gap={20}>
                        <div className="contact__send-message">
                            ...
                            <div className='form-group'>
                                <textarea style={{border:"solid 2px #483434"}}
                                    name='message'
                                    id='message'
                                    className='form-control'
                                    rows='5'
